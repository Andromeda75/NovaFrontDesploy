        ...
        <div className="card-body p-4 pt-0">
          ...
          <div className="py-2">
            <p className="fw-bold ms-3 mb-0 text-start color-2">
              Su pago ha sido procesado correctamente. Por favor, espere mientras preparamos su pedido para el envío de su paquere. Le 
              notificaremos el proceso de su pedido.
            </p>
          </div>
