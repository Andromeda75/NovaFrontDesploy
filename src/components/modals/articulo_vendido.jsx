...
function ArticuloVendido({ cerrar }) {
  return (
        ...
        <div className="card-body p-4 pt-0">
          <div className="d-flex align-items-center gap-3 mb-3 border-bottom pb-3">
            ...
            <h3 className="fw-bold m-0 color-1">
              Artículo vendido con éxito
            </h3>
          </div>
          <div className="py-2">
            <p className="fw-bold ms-3 mb-0 text-start color-2">
              El comprador ha realizado el pago correctamente.
            </p>
            <p className="fw-bold ms-3 text-start color-2">
              Se procedera con la preparación y envío del artículo.
            </p>
          </div>
...
export default ArticuloVendido;
