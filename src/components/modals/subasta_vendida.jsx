...
function Subastavendida({ cerrar }) {
  return (
        ...
        <div className="card-body p-4 pt-0">
          ...
          <div className="py-2">
            <p className="fw-bold ms-3 text-start color-2">
              Tu subasta ha finalizado y tu artículo ha sido vendido exitosamente. El comprador ha sido notificado y deberá completar el pago dentro del tiempo establecido.
            </p>
            <p className="fw-bold ms-3  text-start color-2">
              Te informaremos una vez que el pago sea confirmado para que puedas continuar con el proceso de envío.
            </p>
          </div>
