...
function Vistas_s({ imagen }) {
  return (
    ...
    <div className="card-body">
        ...
        <small className="color-3 fw-bold">ARTESANIA</small>
        <small className="text-muted"><i className="bi bi-people me-1"></i>12 pujas</small>
        </div>
        <h5 className="fw-bold color-1">Juego de muñecas artesanales de Yucatan</h5>
        ...
        <div className="col-6">
            ...
            <span className="fw-bold color-2">$500.00 MXN</span>
        </div>
