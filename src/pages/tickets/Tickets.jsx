  ...
  return (
    <>
      <div className="container py-5 bg-light">
              ...
              return (
                <Col md={4} key={paquete.id}>
                  <Card className={`p-4 shadow border-7-P position-relative mov-card ${index === 1 ? 'mt-0' : 'mt-3'}`}>
                    {esPopular && (
                      <span className="position-absolute top-0 start-50 translate-middle px-5 py-1 text-white" style={{ backgroundColor: "#9A5F25", borderRadius: "5px" }}>
                        MÁS POPULAR
                      </span>
                    )}
                    ...
                    <Button 
                      className="mt-3 btn-linear-gradient btn-onda"
        ...
        <div className="mt-5 p-5" style={{ backgroundColor: '#471900', borderRadius: '20px', color: 'white' }}>
