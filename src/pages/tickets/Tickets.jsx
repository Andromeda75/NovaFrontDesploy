...
function Tickets() {
  ...
  const cargarMetodosPago = async () => {
    try {
      const metodos = await ticketsService.getMetodosPago();
  ...
  const handleComprar = (paquete) => {
    ...
    if (metodosPago.length === 0) {
      showModalMessage('Atención', 'No tienes métodos de pago registrados. Por favor, agrega uno en Configuración.', 'warning');
  ...
  const confirmarCompra = async () => {
      ...
      setProcesando(true);
      try {
          const response = await ticketsService.comprarPaquete(
            ...
            <div className="mb-4">
              ...
              {metodosPago.length > 0 ? (
                metodosPago.map(metodo => (
                  ...
                  >
                    ...
                    <div className="flex-grow-1">
                      ...
                      <small className="text-muted">{metodo.numero_tarjeta_enmascarado}</small>
                    </div>
                ...
                <div className="alert alert-warning">
                  ...
                  <a href="/perfil/configuracion" className="ms-2">Agrega uno aquí</a>
                </div>
              )}
            </div>
            {paqueteSeleccionado && (
        ...
        <div className="modal-content border-0 shadow-lg" style={{ borderRadius: '25px', overflow: 'hidden' }}>
          ...
          <Modal.Body className="text-center p-4">
            ...
            <div className="alert alert-info mt-3">
              ...
              Redirigiendo a tu historial de tickets...
            </div>
          </Modal.Body>
        </div>
      </Modal>
