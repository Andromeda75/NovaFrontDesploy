...
import background from "/src/assets/css/ocean.module.css";
...
function Login() {
    ...
    // Obtener la ruta a donde intentaba ir el usuario antes del login
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            // Redirigir según el rol O a la ruta guardada
            if (from !== '/' && from !== '/login' && !from.includes('/admin')) {
                // Si venía de una ruta específica (ej: tickets/success), redirigir allí
                navigate(from);
            } else if (rolId === 1) {
