...
function Home() {
    ...
    const cargarDatos = async () => {
        ...
        try {
            ...
            console.log('📦 Subastas recibidas:', subastaData);
            
            // ✅ Verificar esMegaSubasta
            subastaData.forEach(s => {
                console.log(`  ${s.titulo}: esMegaSubasta = ${s.esMegaSubasta} (${typeof s.esMegaSubasta})`);
            });
    ...
    // ✅ FILTRAR: Mostrar solo MegaSubastas activas
    const subastasFiltradas = subasta.filter(s => 
        s.estado_id === 8 && 
        (s.esMegaSubasta === true || s.esMegaSubasta === 1 || s.esMegaSubasta === "1")
    );
    ...
    return(
    <>
        <div className="container py-3 px-4 mw-100 bg-light homeBody">
            <Category></Category>
            <div 
                                ...
                                <div className="position-relative">
                                    ...
                                    style={{
                                        ...
                                        <div className="card card-transparent border-0 p-4">
                                            ...
                                            <h1 className="color-2 fw-bold mb-3">
            ...
            <div className='mb-4'>
                <h1 className="color-2 fw-bold mb-2">MegaSubastas</h1>
                <p className="color-3 fs-5">
                    Descubre colecciones exclusivas en nuestras MegaSubastas.
                </p>
                    ...
                    <div className="carousel-inner">
                            {subastasAgrupadas.length > 0 ? (
                                                ...
                                                {grupo.map((item) => (
                                                    <div key={item.id} className="col-md-4">
                                                        <SubastaCard 
                                                            {...item} 
                                                            isPage={true}
                                                            esMegaSubasta={item.esMegaSubasta || false}
                                                            cantidadArticulos={item.total_articulos || 0}
                                                            portada={item.portada || item.img1}
                                                        />
                                                    </div>
                                                ))}
                                ...
                                <div className="col-12 text-center py-5">
                                    <i className="bi bi-folder-x fs-1 text-muted"></i>
                                    <h5 className="mt-3 text-muted">
                                        No hay MegaSubastas activas por el momento.
                                    </h5>
                                </div>
                            )}
                    </div>
            ...
            <div className="card bg-color-4 border-0 shadow-sm text-white mt-5 rounded-4">
                <div className="card-body">
                    <h1 className="fw-bold mb-2">Artistas Destacados</h1>
                
                    <p className="fonts-size-text mb-3 fs-5">
