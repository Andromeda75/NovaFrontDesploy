...
import card6 from '../../assets/img/illustrations/categories/arte-visual/imgA_V6.jpg';
      ...
      <Container fluid="xxl" className="my-4 flex-grow-1 px-lg-5">
        ...
        <Row className="g-4">
          <Col lg={7}>
            ...
            <Row className="g-2 ">
              <Col xs={4}><div className="bg-color-5 rounded-3 shadow-sm" style={{ height: '140px', backgroundImage: `url(${card6})`, backgroundSize: 'cover', backgroundPosition: 'center', backgroundRepeat: 'no-repeat' }}></div></Col>
              <Col xs={4}><div className="bg-color-5 rounded-3 shadow-sm" style={{ height: '140px', backgroundImage: `url(${card6})`, backgroundSize: 'cover', backgroundPosition: 'center', backgroundRepeat: 'no-repeat' }}></div></Col>
              <Col xs={4}><div className="bg-color-5 rounded-3 shadow-sm" style={{ height: '140px', backgroundImage: `url(${card6})`, backgroundSize: 'cover', backgroundPosition: 'center', backgroundRepeat: 'no-repeat' }}></div></Col>
            </Row>
          </Col>
