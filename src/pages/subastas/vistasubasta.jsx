  ...
  return (
    <div className="bg-color-white w-100 d-flex flex-column">
      ...
      <Container fluid="xxl" className="my-4 flex-grow-1 px-lg-5">
        <Button variant="link" className="text-decoration-none color-2 p-0 mb-3 fw-bold" onClick={() => setView('detalle')}>
        <i className="bi bi-arrow-left me-2"></i>Volver a explorar
        </Button>
              ...
              <div className="d-flex flex-column gap-4">
                <Card className="border-0 shadow-sm rounded-4 p-4">
                  <div className="d-flex align-items-center mb-4">
                    <div className="bg-color-4 rounded-3 me-3 overflow-hidden shadow-sm" style={{ width: '55px', height: '55px' }}>
                      <img src="/img/iconos/user.png" alt="Usuario" className="w-100 h-100 object-fit-cover"/>
                    </div>
                    <div>
                      <h6 className="m-0 fw-bold color-1">Marcos T.</h6>
                      <small className="text-warning"> <i className="bi bi-star-fill"></i> 4.9 / 5.0</small>
                    </div>
                    <div className='ms-auto'>
                      <img src="/img/iconos/heart.png" alt="Favoritos" style={{ height: '24px', width: 'auto', cursor: 'pointer' }} />
                    </div>  
                  </div>
                  ...
                  <div className="d-flex justify-content-between align-items-start mb-2">
                    ...
                    <div className="d-flex align-items-center gap-2 color-2">
                      <img src="/img/iconos/users.png" alt="Pujadores" style={{ height: '20px' }} />
                  ...
                  <Button className="bg-color-1 border-0 w-100 py-3 fw-bold mb-2 shadow-sm d-flex align-items-center justify-content-center gap-2" onClick={() => setView('checkout')}>
                    <img src="/img/iconos/pujar_icon.png" alt="" style={{ height: '18px', filter: 'brightness(0) invert(1)' }} />
                    <i className="bi bi-arrow-up-right me-2"></i>  PUJAR AHORA
                  </Button>
                  <small className="text-center d-block text-muted fw-bold">PUJA MÍNIMA:  MXN</small>
                </Card>
                <Card className="border-0 shadow-sm rounded-4 p-4">
                ...
                <div className="mb-4">
                  ...
                  <div className="border rounded-3 p-3 d-flex align-items-center bg-light">
                    <div className="bg-white border rounded p-2 me-3">
                      <img src="/img/iconos/hand.png" alt="Visa" style={{ height: '40px', width: 'auto' }} />
                    </div>
                    <div>
